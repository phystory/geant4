...
G4int numberTubes=ConfigDet->TotalNumberofTube();
  ...
  //------------------------materials that will be used for the He-tube
  ...
  //------------------------detector components/volumes------------------------
	...
	BeamPipeOuter_phys = new G4PVPlacement(0,G4ThreeVector(0,0,0),
...
//------------------------------ (Parametrised) Al-Tubes surrounding the 3He-Tubes
	...
	G4VSolid * AlTubes_Param_tubs
    		= new G4Tubs("AlTubes_Param_tubs",1.*cm,
                                    4.*cm,heightOfAlTube,
...
//			   kZAxis, numberTubes, AlTubes_Param);
	...
	G4VisAttributes* AlTubes_Param_logVisAtt
    		= new G4VisAttributes(G4Colour(1.,1.0,1.0));
...
///        HeTube_phys = new G4PVPlacement(0,G4ThreeVector(0,0,0),
///                                    HeTubes_Param_log ,"HeTube_phys",AlTubes_Param_log,false,0);
